    ...
    return (
      <div className={`main-container ${!this.state.mounted ? 'hidden' : ''}`}>
        <Helmet>
          ...
          <meta
            name="description"
            content="With vistas stretching over City Hall Park, each condo at 25 Park Row creates a connection between fine interior finishes and breathtaking views of Downtown NYC."
          />
        </Helmet>
        ...
        <Grid fluid>
            ...
            <Col lg={12} className={!this.state.sections[2] ? 'hidden' : 'animate-reveal-delay-0'}>
              <Waypoint onEnter={() => this.triggerAnimation(2, true)} onLeave={() => this.triggerAnimation(2, false)}>
                <Panel
                  ...
                  text={
                    <span>
                      With vistas stretching over City Hall Park
                      <br /> and to the cityscape beyond, each residence creates a connection
                      <br /> between fine interior finishes and breathtaking views.
                    </span>
                  }
                />
              </Waypoint>
              ...
              paths={[
                {
                  ...
                  caption:
                    'The lantern-like living rooms feature panoramic views over three exposures and open onto a gracious terrace.'
                },
                {
          ...
          <Row className="row-extra-margin row-extra-margin-desktop-2">
            <Col lg={12} className={!this.state.sections[6] ? 'hidden' : 'animate-reveal-delay-0'}>
              <Waypoint onEnter={() => this.triggerAnimation(6, true)} onLeave={() => this.triggerAnimation(6, false)}>
                <LargeImage
                  ...
                  src="/images/pages/interiors/master_bedroom_and_terrace"
                  width="100%"
                />
              </Waypoint>
            </Col>
          ...
          <Row className="row-extra-margin row-extra-margin-desktop-2">
            <Col lg={12} className={!this.state.sections[7] ? 'hidden' : 'animate-reveal-delay-0'}>
              <Waypoint onEnter={() => this.triggerAnimation(7, true)} onLeave={() => this.triggerAnimation(7, false)}>
                <LargeImage
                  ...
                  src="/images/pages/interiors/living_room_and_fireplace"
                  width="100%"
                />
              </Waypoint>
            </Col>
              ...
              paths={[
                {
                  ...
                  caption:
                    'Walnut cabinetry is enhanced by a decorative surround and is complemented by a suite of Miele appliances.'
                },
                {
            ...
            <Col lg={12} className={!this.state.sections[15] ? 'hidden' : 'animate-reveal-delay-0'}>
              ...
              >
                <LargeImage
                  ...
                  src="/images/pages/interiors/residential_master_bathroom"
                  width="100%"
                />
              </Waypoint>
            </Col>
