  ...
  render() {
    ...
    return (
      <div className={`contact-container ${!this.state.mounted ? 'hidden' : ''}`}>
        ...
        <Row start="lg" className="row-extra-padding-desktop-3">
          <Col md={6}>
            <div style={address}>
              <a href="https://goo.gl/maps/LW384reRaYR2" rel="noopener noreferrer" target="_blank">
                ...
                <p style={[{ margin: 0 }, address.p]}>New York, NY 10007</p>
              </a>
          ...
          <Col md={6}>
            <a href="https://goo.gl/maps/LW384reRaYR2" target="_blank" rel="noopener noreferrer">
              <img
        ...
        <div>
          <ContactForm toggleThankYou={() => this.toggleThankYou()} />
        </div>
      </div>
    );
  }
